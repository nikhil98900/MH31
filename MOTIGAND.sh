...
cat <<EOL > .devcontainer/devcontainer.json
{
    ...
    "postStartCommand": "echo '*'; echo '*         @LEGENDXOPL Bot Running      *'; echo '*'; python /workspaces/MH31/$(basename "mayur.py")",
    "postCreateCommand": "pip install pymongo python-telegram-bot pyTelegramBotAPI certifi && chmod +x /workspaces/MH31/*",
    "customizations": {
        "vscode": {
            "settings": {
...
git commit -m "Add devcontainer configuration for MH31 with automatic script detection and watermark"
